...
- **Прогресс учеников** — сохраняется в Supabase (`progress`) или в `localStorage`. Фиксируются статусы `know`, `unsure`, `dontknow`, чтобы формировать отдельный список повторения.
...
- **Расписание олимпиад** — таблица мероприятий с фильтрами по статусу, данные Supabase (`schedule`) или JSON.
...
Для синхронизации раздела «Расписание» используйте расширенную структуру:
